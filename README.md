...
* **Header Value:** `<API_Key in database its create a very weak key on first start check the logs>`
...
List uploaded images (/data/${UPLOAD_FOLDER})
...
```json
{
    "status": "200",
    "images-list": [
        "cb03f2d0-0da8-4de6-ae74-d1c729da38b1.gif",
        "d1a9942d-2706-48fd-b448-b5c60bf7531c.gif"
    ]
}
```
...
- **Request Body:** 
    ...
    - 'new_key' query - Typing new API key
    - 'new_key_permissions' query - Typing new key permissions
