...
def reload_config(security: str = Depends(API_key_check)):
    ...
    IMAGE_URL_PREFIX = config["settings"]["URL_PREFIX"]  # ! not working on reload still need restart the APı
...
# 1. Bekçinin hangi başlığa (Header) bakacağını seçiyoruz
...
# 3. Şifreyi kontrol eden kontrol fonksiyonu
